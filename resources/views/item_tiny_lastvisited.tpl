            ...
            <div class="lastVisit" id="a_{$item.ID}">
                <div class="lastVisitItem">
                    <a href="{$item.itemLink}">
                        <img src="{$item.medien[0]->medium.bild_url_mini}" width="50" alt="{$item.kurzbezeichnung}" title="{$item.kurzbezeichnung}" />
                    </a>
                </div>
                ...
                <div class="hidden lastVisitItemZoom" id="b_{$item.ID}">
                    <div>
                        ...
                        <div style="text-align:center;height:120px;">
                            <a href="{$item.itemLink}"><img src="{$item.medien[0]->medium.bild_url_mini}" width="50" alt="{$item.kurzbezeichnung}" title="{$item.kurzbezeichnung}" /></a>
                        </div>
                        <div style="text-align:center;">
                            <div class="small" style="">
                            <a href="{$item.itemLink}">{$item.kurzbezeichnung|truncate:70:"...":true:false}</a>
                            </div>
