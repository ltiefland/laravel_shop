                ...
                <div class="item_slider_inner">
                    ...
                    <div class="item_slider_img">
                        ...
                        <a href="{$itemKBA.itemLink}" title="Zum Artikel {$itemKBA.kurzbezeichnung}">
                            <img style="max-height:120px;" src="{$itemKBA.medien[0]->medium.bild_url_mini}" {if $itemKBA.medien[0]->medium["beschreibung"] != ""}alt="{$itemKBA.medien[0]->medium["beschreibung"]}" title="{$itemKBA.medien[0]->medium["beschreibung"]}"{else}alt="{$item.kurzbezeichnung}" title="{$itemKBA.kurzbezeichnung}" {/if}/>
                        </a>
